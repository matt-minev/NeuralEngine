...
def comprehensive_universal_test_evaluation(model, X_test, y_test):
    ...
    # Random vs trained performance comparison
...
def per_character_analysis(results, max_chars_to_show=20):
    """Analyze performance for individual characters (showing worst performers)."""
...
def analyze_confusion_patterns(results):
    """Analyze common confusion patterns in predictions."""
...
def data_integrity_check(X_test, y_test):
    """Check data integrity and preprocessing quality."""
...
def create_universal_visualizations(results, char_stats, type_stats, model_data):
    """Create comprehensive visualization charts for universal character recognition."""
...
def generate_universal_report(results, char_stats, type_stats, model_data):
    """Generate a comprehensive text report for universal character recognition."""
