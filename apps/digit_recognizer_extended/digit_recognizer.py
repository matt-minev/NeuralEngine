...
# get activations from method directly
from utils import ActivationFunctions
...
class DigitRecognizerApp:
    ...
    def _load_or_create_model(self):
        ...
        model_path = os.path.join(os.path.dirname(__file__), 'models', 'enhanced_digit_model.pkl')
    ...
    def _create_demo_model(self):
        ...
        print(f"  Status: Ready for training or prediciton")
    ...
    def _on_digit_drawn(self, digit_array: np.ndarray):
        ...
        try:
            ...
            # enhance the drawing for better recogntion
    ...
    def _training_complete(self):
        ...
        self._update_status("NeuralEngine model training completed succesfully!")
